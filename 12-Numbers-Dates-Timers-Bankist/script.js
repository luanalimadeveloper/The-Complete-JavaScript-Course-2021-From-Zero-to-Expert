...
const formatMovemtDate = function (date, locale) {
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const displayDate = formatMovemtDate(date, acc.locale);
...
// math.trunc to remove decimal part
// + 1 is for get number between 1 and 6
...
console.log(isEven(23)); // odd number
...
console.log(new Date('Sep 23 2021 22:27:23'));
...
console.log('EN: ', new Intl.NumberFormat('en-GB', options).format(num));
