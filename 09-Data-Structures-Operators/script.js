...
document.querySelector('button').addEventListener('click', function () {
  const text = document.querySelector('textarea').value;
  const rowns = text.split('\n');
  //console.log(rowns);

  for (const [i, row] of rowns.entries()) {
    const [first, second] = row.toLowerCase().trim().split('_');
    //onsole.log(row, first, second);
...
capitalizeName('luana daiana lima');

// Padding
const message = 'Go to gate 23!';
console.log(message.padStart(20, '+').padEnd(30, '+'));
console.log('Luana'.padStart(20, '*').padEnd(30, '*'));
...
console.log(maskCreditCArd(4736276438733));
console.log(maskCreditCArd(356573));

// Repeat

const message2 = 'Bad waether.. All Departs Delayed...';
...
// Comparing emails
const email = 'hello@luana.io';
const loginEmail = '  Hello@Luana.Io \n';
